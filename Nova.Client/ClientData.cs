...
namespace Nova.Client
{
    ...
    public sealed class ClientData
    {
        ...
        private string SelectRace(string gameFolder)
        {
            ...
            {
                List<string> raceNames = raceFiles
                    .Select(file => Path.GetFileNameWithoutExtension(file.FullName))
                    .ToList();

                raceName = PlatformHooks.AskUserToSelectRace(raceNames);
                if (raceName == null)
                {
