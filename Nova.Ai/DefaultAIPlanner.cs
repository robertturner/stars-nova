    ...
    public class DefaultAIPlanner
    {
        ...
        public ShipDesign TransportDesign
        {
            ...
            get
            {
                ...
                if (transportDesign != null && !ShipDesignRefresher.IsDueForRefresh(transportDesign, clientState.EmpireState.TurnYear))
                {
                    // already have a design set, and it isn't old enough to be worth replacing
                ...
                else if (clientState.EmpireState.ResearchLevels > new TechLevel(0, 0, 0, 7, 0, 8))
                {
                    ...
                    transportDesign.Icon = new ShipIcon(freighterHull.ImageFile, freighterHull.ComponentImage);

                    transportDesign.Type = ItemType.Ship;
                    transportDesign.Name = ShipDesignRefresher.NameWithTurnSuffix("AI Transport", clientState.EmpireState.TurnYear);
