...
namespace Nova.ControlLibrary
{
    ...
    /// <summary>
    /// A progress dialog box. Moved here from Nova.Common (see PROJECT-STATUS.md's Android-
    /// portability section) so Common carries no WinForms Form dependency; this is now the sole
    /// place PlatformHooks.RunWithProgressDialog's WinForms host implementation constructs one.
    /// </summary>
